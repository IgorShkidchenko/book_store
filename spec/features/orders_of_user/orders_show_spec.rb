...
describe 'Orders show', type: :feature, js: true do
  ...
  context 'when visit order what belong to user' do
  ...
  context 'when try to visit order of another user' do
    ...
    it 'redirect to root with flash' do
      expect(page).to have_current_path root_path
      expect(page).to have_selector 'div', text: I18n.t('cancan.error')
    end
  end
end
